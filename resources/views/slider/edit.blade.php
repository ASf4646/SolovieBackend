...
@section('content')
@include('layouts.shared/page-title', ['sub_title' => 'Slider', 'page_title' => 'Edit Slider'])
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('slider.update', $slider->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" id=" example-textarea" rows="5">{{ old('description', $slider->description) }}
                                </textarea>
                            </div>
                ...
                <button class="btn btn-success" type="submit">{{__("Update Slider")}}</button>
                <a href="{{route('slider.index')}}" class="btn btn-primary" type="submit">{{__("Cancel")}}</a>
                </form>
